...
licencia_buffer_ruta_121 <-
  st_join(licencia, buffer_ruta_121)

plot(
  st_union(buffer_ruta_121),
  main = "Centros educativos en ruta nacional 121",
  axes = TRUE,
  graticule = TRUE
)

plot(ruta_121$geometry,
     col = "turquoise",
     add = TRUE)
